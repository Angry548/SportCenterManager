...
public class MetodoPagoController {
    ...
    public String index(
        ...
        Page<MetodoPago> metodosPago =
                metodoPagoService.obtenerTodosPaginados(pageable);
    ...
    @GetMapping("/create")
    public String create(MetodoPago metodoPago) {
        return "metodoPago/create";
    }

    @PostMapping("/save")
    public String save(
            @Valid MetodoPago metodoPago,
